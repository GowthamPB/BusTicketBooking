...
public class Customer_Dashboard extends AppCompatActivity implements BusRVAdapter.BusClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //addFAB.setOnClickListener(view -> startActivity(new Intent(Customer_Dashboard.this, Add_Bus.class)));
        getAllBuses();
    }
    ...
    private void displayBottomSheet (BusRVModel busRVModel){
        ...
        Button bookBtn = layout.findViewById(R.id.idBtnBookBus);
        ...
        bookBtn.setOnClickListener(v -> {
            Intent i = new Intent(Customer_Dashboard.this, Book_Bus.class);
